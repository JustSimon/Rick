...
import com.dre3m.utils.MusicController;
...
public class Splash implements Screen {
	...
	//method\\Constructor--
	public Splash(Game game, ActionResolver actionResolver) {
		this.game = game;
	...
	public void show() {
		...
		MusicController.startMusic(0.2f);
	...
	public void render(float delta) {update();draw();}
		...
		public void update() {
			...
			if (Gdx.input.isTouched()) game.setScreen(new Menu(game, actionResolver));;
